...
const PLATFORMS = [
  ...
  },
  {
    ...
    badge:"Hindi Dub + Eng Sub", tagline:"Episodes 1–96 · Select Movies",
  ...
  },
  {
    ...
    description:"ETV Win is ETV's official streaming platform. A subscription is required to watch. Select movies that aired on ETV Bal Bharat are available to stream online in Telugu.",
    note:"Requires an ETV Win subscription.",
    movies:[2,4,5],
    languages:{dub:["Telugu"]}
  }
];
...
const MOVIES = [
  {n:1,  id:"timebombed",        tmdb:21422,  title:"The Time-Bombed Skyscraper",       year:1997, colors:["#8B1A1A","#C0392B"],
   ...
   netflixUrl:'https://www.netflix.com/title/70055218', youtubeId:'DEtrScim2p8',
  ...
  {n:2,  id:"fourteenth",        tmdb:21452,  title:"The Fourteenth Target",            year:1998, colors:["#1A3A5C","#2980B9"],
   ...
   netflixUrl:'https://www.netflix.com/watch/70082582', youtubeId:'0YkzEM88_aA',
  ...
  {n:3,  id:"lastwizard",        tmdb:28808,  title:"The Last Wizard of the Century",   year:1999, colors:["#3A1A6B","#8E44AD"],
   ...
   netflixUrl:'https://www.netflix.com/title/70126871', youtubeId:'ZmmRi0f6g_Y',
  ...
  {n:4,  id:"capturedineyes",    tmdb:20677,  title:"Captured in Her Eyes",             year:2000, colors:["#6B1A50","#E91E8C"],
   netflix:true,  etv:true,  pvr:false, animetimes:false, etvwin:true,
   netflixUrl:'https://www.netflix.com/title/70126872', youtubeId:'8VcCCeoQ0cE',
  ...
  {n:5,  id:"countdown",         tmdb:32022,  title:"Countdown to Heaven",              year:2001, colors:["#1C3A6B","#2196F3"],
   netflix:true,  etv:true,  pvr:false, animetimes:false, etvwin:true,
   netflixUrl:'https://www.netflix.com/title/70128058', youtubeId:'1CzQoXmyf68',
  ...
  {n:6,  id:"phantombaker",      tmdb:26662,  title:"The Phantom of Baker Street",      year:2002, colors:["#4A3000","#8B6914"],
   netflix:true,  etv:true,  pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/watch/70129025', youtubeId:'_sTt0YuS_aY',
  ...
  {n:7,  id:"crossroad",         tmdb:39202,  title:"Crossroad in the Ancient Capital",  year:2003, colors:["#7B1F1F","#C0392B"],
   netflix:true,  etv:true,  pvr:false, animetimes:true,  etvwin:false,
   netflixUrl:'https://www.netflix.com/title/81757599', youtubeId:'2WnzzQHlJZM',
  ...
  {n:8,  id:"magiciansilver",    tmdb:39203,  title:"Magician of the Silver Sky",       year:2004, colors:["#1A4030","#27AE60"],
   ...
   netflixUrl:'https://www.netflix.com/title/81757598', youtubeId:'GcxWFlpsgSs',
  ...
  {n:9,  id:"strategyabove",     tmdb:39204,  title:"Strategy Above the Depths",        year:2005, colors:["#0D2137","#1565C0"],
   ...
   netflixUrl:'https://www.netflix.com/watch/81757585', youtubeId:'YPXfQ0_j7X0',
  ...
  {n:10, id:"privateeyesreq",    tmdb:39205,  title:"The Private Eye's Requiem",        year:2006, colors:["#1A1A2E","#E94560"],
   netflix:true,  etv:false, pvr:false, animetimes:true,  etvwin:false,
   netflixUrl:'https://www.netflix.com/title/81757597', youtubeId:'26h0Bqt1Qjw',
  ...
  {n:11, id:"jollyroger",        tmdb:39206,  title:"Jolly Roger in the Deep Azure",    year:2007, colors:["#0A2744","#0288D1"],
   netflix:true,  etv:false, pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/title/81757588', youtubeId:'hvn22qYmGSA',
  ...
  {n:12, id:"fullscore",         tmdb:39207,  title:"Full Score of Fear",               year:2008, colors:["#1A0A2E","#7B1FA2"],
   netflix:true,  etv:false, pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/title/81757587', youtubeId:'lcaMVTY5ck8',
  ...
  {n:13, id:"ravenchaser",       tmdb:28764,  title:"The Raven Chaser",                 year:2009, colors:["#0D0D0D","#B71C1C"],
   netflix:true,  etv:false, pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/watch/81757586', youtubeId:'sn6NMv3APS0',
  ...
  {n:14, id:"lostship",          tmdb:97375,  title:"The Lost Ship in the Sky",         year:2010, colors:["#0D1B2A","#1E88E5"],
   netflix:true,  etv:false, pvr:false, animetimes:true,  etvwin:false,
   netflixUrl:'https://www.netflix.com/title/81757579', youtubeId:'tWog2Im1PjA',
  ...
  {n:15, id:"quartersilence",    tmdb:77617,  title:"Quarter of Silence",               year:2011, colors:["#1A2A3A","#78909C"],
   netflix:true,  etv:false, pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/watch/81757580', youtubeId:'Y1uqbHDW_so',
  ...
  {n:16, id:"eleventhstriker",   tmdb:122583,  title:"The Eleventh Striker",             year:2012, colors:["#1A3A1A","#388E3C"],
   netflix:true,  etv:true,  pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/title/81757602', youtubeId:'j5G277fzQng',
  ...
  {n:17, id:"privateeyedist",    tmdb:228805,  title:"Private Eye in the Distant Sea",   year:2013, colors:["#0D1F3C","#0D47A1"],
   netflix:true,  etv:true,  pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/watch/81757603', youtubeId:'gArsI5qqUBM',
  ...
  {n:18, id:"dimensionalsniper", tmdb:257512,  title:"Dimensional Sniper",               year:2014, colors:["#1A1A1A","#607D8B"],
   netflix:true,  etv:true,  pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/title/81757601', youtubeId:'XQG4DG7zCH0',
  ...
  {n:19, id:"sunflowers",        tmdb:316873,  title:"Sunflowers of Inferno",            year:2015, colors:["#3D2B00","#F9A825"],
   netflix:true,  etv:true,  pvr:false, animetimes:true,  etvwin:false,
   netflixUrl:'https://www.netflix.com/title/81757600', youtubeId:'ih1PrYA0pQQ',
  ...
  {n:20, id:"darkestnightmare",  tmdb:374856,  title:"The Darkest Nightmare",            year:2016, colors:["#0A0A1A","#1A237E"],
   netflix:true,  etv:true,  pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/watch/81757584', youtubeId:'ZZ-FzCK9Uq4',
  ...
  {n:21, id:"crimsonlove",       tmdb:438058,  title:"The Crimson Love Letter",          year:2017, colors:["#3D0000","#C62828"],
   netflix:true,  etv:true,  pvr:false, animetimes:true,  etvwin:false,
   netflixUrl:'https://www.netflix.com/watch/81757605', youtubeId:'d44tuuPbAw8',
  ...
  {n:22, id:"zeroenforcer",      tmdb:493006,  title:"Zero the Enforcer",                year:2018, colors:["#0A1A2A","#0288D1"],
   netflix:true,  etv:true,  pvr:false, animetimes:false, etvwin:false,
   netflixUrl:'https://www.netflix.com/watch/81757618', youtubeId:'i1EDdyF109c',
  ...
  {n:23, id:"fistblue",          tmdb:566555,  title:"The Fist of Blue Sapphire",        year:2019, colors:["#001A3A","#0052D9"],
   netflix:true,  etv:true,  pvr:false, animetimes:true,  etvwin:false,
   netflixUrl:'https://www.netflix.com/watch/81757604', youtubeId:'2X-JSRWnH1Y',
  ...
  {n:28, id:"oneyedflashback",   tmdb:1396965,   title:"The One-Eyed Flashback",           year:2025, colors:["#1A1A2E","#546E7A"],
   netflix:false, etv:false, pvr:false, animetimes:false, etvwin:false, noIndiaAnnouncement:true, youtubeId:'OhamdzseR4o',
  ...
  {n:29, id:"fallenangel",       tmdb:1545621,   title:"Fallen Angel of the Highway",      year:2026, colors:["#0A0A1A","#3949AB"],
   netflix:false, etv:false, pvr:false, animetimes:false, etvwin:false, noIndiaAnnouncement:true, youtubeId:'qgn49U52AU0',
  ...
  {n:30, id:"movie30",           tmdb:null,   title:"Untitled Movie 30",                year:2027, colors:["#0A1A0A","#1B5E20"],
   netflix:false, etv:false, pvr:false, animetimes:false, etvwin:false, noIndiaAnnouncement:true, youtubeId:'PZ4_qQp8U8I',
...
const SEASONS = [
  ...
  {id:"S3",  label:"Season 3 (1998)",  year:1998, epRange:[86,128],    available:true,
   platforms:["netflix","primevideo","appletv","etvbalb"], animetimesRange:[86,96]},
  ...
  {id:"S22",  label:"Season 22 (2017)",  year:2017, epRange:[845,886],    available:false,
   platforms:[], unavailableNote:"Not available on any Indian streaming platform."},
  {id:"S23",  label:"Season 23 (2018)",  year:2018, epRange:[887,926],    available:true,
   platforms:["netflix"]},
  {id:"S24",  label:"Season 24 (2019)",  year:2019, epRange:[927,964],    available:true,
   platforms:["netflix"]},
  {id:"S25",  label:"Season 25 (2020)",  year:2020, epRange:[965,992],    available:true,
   platforms:["netflix"]},
  ...
  {id:"S30",  label:"Season 30 (2025)",  year:2025, epRange:[1148,1186],    available:false,
   platforms:[], unavailableNote:"Currently airing in Japan. Not yet on any Indian platform."},
  {id:"S31",  label:"Season 31 (2026)",  year:2026, epRange:[1187,null],    available:true,
   platforms:["netflix"]},
];
...
const MAGIC_KAITO = {
  ...
  languages:{dub:[],sub:[]},
  netflix:false, amasiantv:false, availableInIndia:false,
  note:"Not currently available on any streaming platform in India.",
  cast:[
...
const YAIBA = {
  id:"yaibasamurailegend", tmdb:254017, title:"Yaiba: Samurai Legend", year:2025, type:"series",
  seasons:1, episodes:24,
  colors:["#1A0A00","#B84A00"],
  desc:"Yaiba Kurogane is determined to become a true samurai. After an encounter with the villainous Takeshi Onimaru — who wields the supernatural Sword of Fujin — Yaiba embarks on an epic quest collecting mystical orbs to save Japan.",
  languages:{dub:["English","Hindi"],sub:["English"]},
  netflix:true, animetimes:true, availableInIndia:true,
  netflixUrl:"https://www.netflix.com/title/81700000",
  animetimesUrl:"https://www.primevideo.com/region/eu/detail/0OC9KEZFABTSZYY17K30E90A8W/",
  note:"Netflix has the English dub. Anime Times has the Hindi dub. Season 1 has 24 episodes.",
  netflixLanguages:{dub:["English"],sub:["English"]},
  animetimesLanguages:{dub:["Hindi"],sub:["English"]}
};

const YAIBA_EPISODES = [
  {n:1,  title:"Yaiba Appears",                 tags:["New Character","Characters Pasts"],   desc:"Yaiba Kurogane is determined to become a true samurai, but things take an odd turn in the jungle."},
  {n:2,  title:"Sword of Fujin, Reborn",         tags:["New Character","Character Development"], desc:"Yaiba has come up with a plan and is willing to do nearly anything to provoke Onimaru to a duel."},
  {n:3,  title:"Another Magic Sword",            tags:["New Character","Character Development"], desc:"Onimaru now wants to fight Yaiba, but something's off, not least the horns sprouting from his head."},
  {n:4,  title:"Attack of the Eight Demons",     tags:["New Character","Character Development"], desc:"Yaiba has the Raijinken but it's the Thunder God that turns the tables on him. Then there's Onimaru."},
  {n:5,  title:"Onsen Fun",                      tags:["New Character","Character Development"], desc:"Yaiba and others head to Ganryu Island to learn about an arcane maken but end up at a shady hot spring."},
  {n:6,  title:"The Unexpected Bat Guy",         tags:["New Character","Character Development"], desc:"Yaiba and crew are back on track but stop in Nagoya where there's more in store than great food."},
  {n:7,  title:"Kojiro Resurrected",             tags:["New Character","Characters Pasts"],   desc:"Yaiba makes it to Ganryu Island, but the idyllic scenery hides something sinister, something undead!"},
  {n:8,  title:"The Duel at Ganryu Island",      tags:["New Character","Character Development","Characters Pasts"], desc:"Yaiba's pulled into a time portal with only one way out! If only he could keep his big mouth shut."},
  {n:9,  title:"Dawn of the Lightning Slash",    tags:["Character Development"],              desc:"Yaiba's training's working. He can handle the Raijinken, but it's exhausting. Bring on the training!"},
  {n:10, title:"Onimaru's Devil Kings",          tags:["Character Development"],              desc:"Yaiba's slicing his way to Onimaru Castle, a place he learns that deceives the senses and the mind."},
  {n:11, title:"Sword of Raijin vs Sword of Fujin", tags:["Character Development"],          desc:"While Yaiba rides high, Onimaru tempts the young hero. And in pure Yaiba fashion, eyebrows rise."},
  {n:12, title:"Nadeshiko Yamato Is Calling",    tags:["New Character","Character Development","Romance","Characters Pasts"], desc:"A showdown's heating up between Yaiba and Onimaru, but the neighborhood rumor mill is even hotter."},
  {n:13, title:"Find the Dragon God Orb",        tags:["Character Development"],              desc:"Yaiba and team learn of an orb that promises gravity-defying powers. But an undead assassin awaits..."},
  {n:14, title:"The Rise of Ninja Kotaro",       tags:["Character Development"],              desc:"Lake Biwa's orb surprises, but it's Shikoku's Mt. Tsurugi that hides a shadowy and dangerous threat."},
  {n:15, title:"Showdown! Magician vs. Yaiba",   tags:["Character Development"],              desc:"Team Yaiba may have secured the Gold Orb on Shikoku, but it's on to Kyushu, and on Yaiba's back."},
  {n:16, title:"A Battle of Giants",             tags:["New Character","Character Development","Romance"], desc:"Troupe Yaiba traipses to Nara for a pivotal tip-off, but it's an odd traveling warrior who shows up."},
  {n:17, title:"The Man of Yagyu Shinkage-ryu",  tags:["New Character","Character Development"], desc:"Yaiba battles Goemon using the Orb of Giants only to lose two of the spheres to the villain's guile."},
  {n:18, title:"Crisis on Kawanakajima",         tags:["New Character","Character Development","Romance"], desc:"Jubei's giving Yaiba and team a fighting chance, but that's before they meet the ninja army."},
  {n:19, title:"Darkness Orb Escape Training",   tags:["New Character","Character Development"], desc:"Yaiba and others unmask the nature of Goemon's orb, and it's unlike anything they've encountered before."},
  {n:20, title:"The Ruse of Monkey Basho",       tags:["New Character","Character Development"], desc:"The team is eager to grab the illusive final prize, but a decrepit temple and old man stand defiant."},
  {n:21, title:"Mystery Atop Mount Fuji",        tags:["Character Development"],              desc:"An off-the-wall sphere guides Yaiba to Mt. Fuji to find the elusive and perilous Dragon God Orb."},
  {n:22, title:"Crossroads of the Soul",         tags:["Character Development"],              desc:"Yaiba arrives at the crater of Mt. Fuji only to be faced with a dilemma he could've never imagined."},
  {n:23, title:"The Dragon God Orb Ressurected!", tags:["New Character","Character Development"], desc:"At the trial to end all trials, the Dragon God desires decisiveness through an impossible choice."},
  {n:24, title:"The Lunar Invaders",             tags:["Character Development"],              desc:"With the ultimate orb and new maken, Yaiba is victorious. But a new battle unfolds over the Pacific."}
];
...
const HERO_SLIDES = [
  ...
  },
  {
    ...
    img:"fallback-images/misc/bbdci-logo.png",
    bgColor:"#000000",
    accent:"#CC2233",
  ...
  },
  {
    ...
    desc:"From The Time-Bombed Skyscraper (1997) to The Million Dollar Pentagram (2024) — 27 films available across Netflix and Anime Times India.",
    img:"fallback-images/platforms/appletv-bg.jpg",
    bgColor:"#000000",
    accent:"#E50914",
  ...
  },
  {
    ...
    img:"fallback-images/platforms/etvbalb-bg.jpg",
    bgColor:"#000000",
    accent:"#FF6B00",
  ...
  },
  {
    title:"600+ Episodes",
    subtitle:"Streaming in India",
    desc:"From Season 1 (1996) all the way to Season 27 — watch across Netflix, Anime Times, Apple TV, and ETV Bal Bharat.",
    img:"fallback-images/platforms/netflix-bg.jpg",
    bgColor:"#000000",
    accent:"#27AE60",
